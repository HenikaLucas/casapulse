...
export default function HunterPricingPage() {

    const metaTitle = "Casapulse " + config.PRODUCT_HUNTER.name + " - Tarifs";
    ...
    const metaImage = config.BASE_URL + "/images/" + config.PRODUCT_HUNTER.path + "/product-illustration.png";
    const metaCanonicalUrl = config.BASE_URL + "/" + config.PRODUCT_HUNTER.path + "/pricing";
            ...
            <Layout>
                ...
                <Container>
                    <Row className="align-items-center justify-content-start">
                        <h1 className="fs-1 fw-bold mb-3">Casapulse <span className="accent-secondary-color">{config.PRODUCT_HUNTER.name}</span></h1>
                        <div className="fs-5">
